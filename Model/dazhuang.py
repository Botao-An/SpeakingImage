...
class DaZhuangNet(nn.Module):
    def __init__(self):
        ...
        self.e_parallel_layer1 = parallel_block(3, 16)
        self.e_down_layer1 = encoder_block(16, 32)
        self.e_down_layer2 = encoder_block(32, 64)
        self.e_down_layer3 = encoder_block(64, 128)
        self.e_down_layer4 = encoder_block(128, 256)
        self.e_down_layer5 = encoder_block(256, 512)
        self.e_center_layer1 = parallel_block(512, 1024)
        self.e_center_layer2 = parallel_block(1024, 512)
        self.e_up_layer5 = decoder_block(1024, 512, 256)
        self.e_up_layer4 = decoder_block(512, 256, 128)
        self.e_up_layer3 = decoder_block(256, 128, 64)
        self.e_up_layer2 = decoder_block(128, 64, 32)
        self.e_up_layer1 = decoder_block(64, 32, 16)
        self.e_parallel_layer2 = parallel_block(32, 16)
        self.e_final = nn.Conv2d(16, 1, kernel_size=1)
    ...
    def forward(self, cover, secret):
        ...
        e_ec6 = self.e_down_layer5(e_ec5)
        e_center = self.e_center_layer1(e_ec6)
        e_dc6 = self.e_center_layer2(e_center)
        e_dc5 = self.e_up_layer5(torch.cat((e_dc6, e_ec6), 1))
